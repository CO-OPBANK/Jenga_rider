...
import ke.co.coopbank.financialliteracy.databinding.FragmentVerifyPhoneBinding
...
class VerifyPhoneFragment : Fragment() {
    ...
    private val args: VerifyPhoneFragmentArgs by navArgs()
                    ...
                    if (it.data?.status == 0) {
                        if (it.data.userExists == true) {
                            ...
                            NavHostFragment.findNavController(this)
                                .navigate(
                                    R.id.action_VerifyPhoneFragment_to_CompleteProfileFragment,
                                    bundle
                                )
                        }
                    }
